                            ...
                            <div class="container px-5 py-5 mx-auto">
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <Link as="botton" :href="route('items.edit', {item: item})" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">商品編集</Link>
                                        <button @click="deleteItem(item.id)" class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">商品削除</button>
                                    </div>
                                </div>
                            </div>
                        </section>
