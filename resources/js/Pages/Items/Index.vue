                            ...
                            <div class="container px-5 py-5 mx-auto">
                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    <tr v-for="item in items">
                                        ...
                                        <td class="border-t-2 border-b-2 border-gray-200 px-4 py-3">{{ item.is_selling }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                                </div>
                                <div class="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
                                    <Link as="botton" :href="route('items.create')" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">商品登録</Link>
