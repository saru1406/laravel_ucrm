...
<template>
    ...
    <input name="customer" v-model="search" class="leading-7 text-sm text-gray-600 mt-5">
    <button @click="searchCustomers" data-micromodal-trigger="modal-1" class="flex text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">検索する</button>
</template>
